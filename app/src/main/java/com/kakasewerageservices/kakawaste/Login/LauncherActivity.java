package com.kakasewerageservices.kakawaste.Login;
...
import com.kakasewerageservices.kakawaste.Driver.DriverMapActivity;
...
public class LauncherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mAuth.getCurrentUser() != null) {
            Log.i("firebase", "user active");
            checkUserAccType();
        } else {
            Log.i("firebase", "user inactive");

package com.kakasewerageservices.kakawaste.Customer;
...
import com.kakasewerageservices.kakawaste.Adapters.TypeAdapter;
import com.kakasewerageservices.kakawaste.History.HistoryActivity;
import com.kakasewerageservices.kakawaste.Login.LauncherActivity;
import com.kakasewerageservices.kakawaste.Objects.CustomerObject;
import com.kakasewerageservices.kakawaste.Objects.LocationObject;
import com.kakasewerageservices.kakawaste.Objects.RideObject;
import com.kakasewerageservices.kakawaste.Objects.TypeObject;
import com.kakasewerageservices.kakawaste.Payment.PaymentActivity;
import com.kakasewerageservices.kakawaste.R;
import com.kakasewerageservices.kakawaste.Utils.SendNotification;
import com.kakasewerageservices.kakawaste.Utils.Utils;
 ...
 */
public class
CustomerMapActivity extends AppCompatActivity
    ...
    private Button rPlumber,rEmptier,sCosts,mMaterials
            ;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rEmptier = findViewById(R.id.request_emptier);


        rEmptier.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Log.i("Firebase","rEmptire clicked");
                getDriversAround();
            }
        });
...
*/
   ...
   /* void initPlacesAutocomplete() {
        if (!Places.isInitialized()) {
            ...
            Log.i("Firebase", "places initialising");
...
*/
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            Log.i("Fire PLACE_AUTOCOMPLETE", status.getStatusMessage());

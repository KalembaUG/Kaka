package com.kakasewerageservices.kakawaste.Driver;
...
import com.kakasewerageservices.kakawaste.Customer.CustomerMapActivity;
import com.lorentzos.flingswipe.SwipeFlingAdapterView;
import com.ncorti.slidetoact.SlideToActView;
import com.kakasewerageservices.kakawaste.Adapters.CardRequestAdapter;
...
import com.kakasewerageservices.kakawaste.Objects.DriverObject;
import com.kakasewerageservices.kakawaste.Objects.RideObject;
import com.kakasewerageservices.kakawaste.Payment.PayoutActivity;
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            if (!gps_enabled && !network_enabled) {
                new AlertDialog.Builder(DriverMapActivity. this )
                        .setTitle("The location must be enabled")
